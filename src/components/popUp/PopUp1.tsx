    ...
    <div className={style.popUpContainer}>
      <div>
        ...
        <p>
          ...
          market trends, derived from rigorous technical and fundamental
          analyses.
          <br />
          <br />
        ...
        <p>
          <div className='fw-700 text-center'>How to Get Started</div>
          <br />
          <br />
        </p>
        <p>
          To begin harnessing the power of IM-AAM, simply explore our platform
          and start uncovering valuable insights into stock price movements.
          While you&apos;ll need to execute trades through external platforms,
          rest assured that our team is here to guide you every step of the way,
          ...
          sprint. Stay disciplined, stay informed, and let Im-AAM be your
          trusted companion on the road to prosperity while upholding the
          highest standards of legality, integrity, and analytical excellence.
          <br /> <br />
          Welcome aboard!
        </p>
      </div>
