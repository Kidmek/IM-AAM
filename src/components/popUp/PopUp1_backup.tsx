...
export default function PopUp1BackUp() {
  return (
    <div className='popUpContainer'>
      <div>
        <p>
          <span className='popUpAttention fw-700'>Attention New Users:</span>{' '}
          <br />
          <br />
        ...
        <p>
          ...
          insights you need to navigate the complexities of the stock market
          with confidence. Utilizing a combination of technical analysis and
          fundamental analysis, we aim to provide you with accurate predictions
          of stock price movements within the boundaries of regulatory
          compliance.
        </p>
        ...
        <p>
          ...
          IM-AAM, we offer a streamlined stock recommendation service designed
          to identify stocks with high potential for growth. For a fee of per
          stock recommendation, clients gain access to specific stock insights
          tailored to their trading style&#x2014;whether they&apos;re daily
          traders, swing traders, or bullish position traders. Each
          recommendation includes key information on optimal purchase times,
          potential gains, and other valuable metrics, helping clients make
          informed decisions with ease. Our goal is to empower clients with
          high-quality insights that align with their investment goals, offering
          value at an affordable rate per stock.
          <br />
          <br />
          At IM-AAM, your success is our top priority. Our team of experienced
          analysts works tirelessly to deliver high-quality stock
          recommendations tailored to your investment goals and risk tolerance.
          We&apos;re here to empower you with the tools and insights you need to
