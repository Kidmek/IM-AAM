import { AttentionPopup2, AttentionPopup1 } from '@/constants/images'
...
export default function AttentionPopup({ onClose }: Props) {
  return (
    <div className={style.popUpContainer}>
      <img src={AttentionPopup1} alt='Image' className={style.popUpImage} />
      <p>
      ...
      <div className={style.popUpButton}>
        <img src={AttentionPopup2} alt='Image' className={style.popUpImage} />
        <CustomButton
